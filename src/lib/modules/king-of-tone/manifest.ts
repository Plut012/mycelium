...
export const kingOfToneManifest: ModuleManifest = {
  id: 'king-of-tone',
  name: 'King of Tone',
  category: 'effect',
  description: 'Throne of Tone, King voicing — open, transparent overdrive with headroom. The octave-feeder: Mode=OD, low gain, into a saturating stage.',
  gridWidth: 4,
  gridHeight: 5,
  inputs: [
